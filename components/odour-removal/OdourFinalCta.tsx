...
export default function OdourFinalCta() {
  return (
    <section className="relative overflow-hidden bg-navy-dark py-20 lg:py-28">
      ...
      <Reveal className="container-page relative text-center max-w-2xl mx-auto">
        ...
        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">
          Tell Us Where the Odour Is Coming From
        </h2>
        <p className="text-white/80 mb-8">
          Whether the problem involves pets, a spill, smoke or an unpleasant smell trapped in carpets or furniture, {siteInfo.name} can help you understand the next step. Tell us what you are noticing, where the smell is strongest and anything you know about its cause.
        </p>
