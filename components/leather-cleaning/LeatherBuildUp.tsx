...
const points = [
  ...
  },
  {
    icon: Wind,
    title: "Spills & Marks",
    description: "Food, drinks and other substances can leave visible marks or affect the leather appearance.",
  },
];

export default function LeatherBuildUp() {
  return (
    <section className="py-16 lg:py-24 bg-light">
      <div className="container-page">
        <Reveal className="max-w-2xl mb-14">
          <h2 className="text-3xl md:text-4xl font-extrabold text-navy-dark mb-6">
            What Builds Up on Leather Through Everyday Use?
          </h2>
          <div className="space-y-4 text-slate-600">
            <p>
              Leather does not hold dirt like carpet or woven upholstery, but it is still affected by everyday life.
            </p>
            <p>
            ...
            <p>
              Leather surfaces, seams and creases can each show use differently.
            </p>
            <p>
              Good leather cleaning services take these differences into account instead of treating leather like ordinary fabric upholstery.
            </p>
          </div>
        </Reveal>
