    ...
    <section className="relative overflow-hidden bg-navy-dark py-20 lg:py-28">
      ...
      <Reveal className="container-page relative text-center max-w-2xl mx-auto">
        ...
        <p className="text-white/80 mb-8">
          Whether your carpets need routine maintenance, a deeper clean or attention to stubborn
          marks, speak to {siteInfo.name} about the right approach for your home or property. Tell
          us what needs cleaning and we can discuss the next step.
        </p>
