...
const features = [
  ...
  },
  {
    ...
    description: "Mattress is approached differently from carpets and ordinary fabric upholstery.",
    span: "",
  },
  {
    icon: Target,
  ...
  },
  {
    ...
    description: "Our professional mattress cleaners focus on sensible treatment and clear communication.",
    span: "md:col-span-2",
  },
];

export default function WhyChooseMattress() {
  return (
    <section className="py-16 lg:py-24 bg-light">
      <div className="container-page">
        <Reveal className="max-w-2xl mb-14">
          <h2 className="text-3xl md:text-4xl font-extrabold text-navy-dark mb-4">
            Mattress Care Based on the Furniture in Front of Us
          </h2>
          <p className="text-slate-600">
            A mattress cleaning company should not approach every sofa with one product. Mattress differs in finish, age and condition. {siteInfo.name} considers these factors and explains what cleaning can realistically achieve.
          </p>
        </Reveal>
