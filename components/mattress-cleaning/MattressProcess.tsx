...
const steps = [
  ...
  },
  {
    ...
    description:
      "The characteristics of the mattress help determine which products and treatment approach may be suitable.",
  },
  {
    number: "04",
    icon: SprayCan,
    ...
    description:
      "Suitable mattress is cleaned using an approach intended for the surface rather than general fabric-cleaning methods.",
  },
  {
    number: "05",
    icon: CheckCircle2,
    title: "Final Review & Drying Guidance",
    description:
      "After cleaning, we check the treated areas and provide relevant mattress-care guidance where appropriate.",
  },
];

export default function MattressProcess() {
  return (
    <section className="py-16 lg:py-24">
      <div className="container-page">
        <Reveal className="max-w-2xl mb-14">
          <h2 className="text-3xl md:text-4xl font-extrabold text-navy-dark mb-4">
            How We Approach Mattress Cleaning
          </h2>
          <p className="text-slate-600">
            Mattress furniture needs to be understood before it is cleaned. Its finish, existing wear and areas requiring attention influence treatment. Our professional mattress cleaning service begins with those considerations.
          </p>
        </Reveal>
