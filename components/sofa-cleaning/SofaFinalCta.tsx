...
export default function SofaFinalCta() {
  return (
    <section className="relative overflow-hidden bg-navy-dark py-20 lg:py-28">
      ...
      <Reveal className="container-page relative text-center max-w-2xl mx-auto">
        <span className="text-xs font-bold uppercase tracking-wide text-accent mb-3 block">
          Ready to Refresh Your Sofa?
        </span>
        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">
          Give Your Sofa the Professional Clean It Needs
        </h2>
        <p className="text-white/80 mb-8">
          Whether your sofa needs a routine refresh, deeper cleaning or attention to individual stains, {siteInfo.name} can help you choose an approach based on its fabric and condition. Tell us about your sofa and what you would like cleaned, and we can discuss the next step.
        </p>
